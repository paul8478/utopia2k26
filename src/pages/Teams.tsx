...
export default function Teams() {
  return (
    <div className="min-h-screen bg-[#fafafa] text-[#0a0a0a] pt-32 pb-20 font-sans selection:bg-[#ff6b35] selection:text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 mb-20 text-center md:text-left">
        ...
        <h1 className="text-5xl md:text-7xl font-black leading-[1.1] tracking-tighter uppercase">
          The Architects <br/>
          <span className="text-black/20 text-4xl md:text-6xl">of Utopia 2k26</span>
        </h1>
      </div>
